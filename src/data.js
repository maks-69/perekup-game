export const PRODUCT_TEMPLATES = [
  ...
  { id: 'earbuds-sport', category: 'Наушники', tier: 0, name: 'Спортивные TWS-наушники', emoji: '🎧', base: 1650 },
  { id: 'earbuds-studio', category: 'Наушники', tier: 0, name: 'Студийные наушники', emoji: '🎧', base: 2800 },
  ...
  { id: 'mouse-trackball', category: 'Мышки', tier: 0, name: 'Мышка с трекболом', emoji: '🖱️', base: 1900 },
  ...
  { id: 'keyboard-lowprofile', category: 'Клавиатуры', tier: 0, name: 'Низкопрофильная клавиатура', emoji: '⌨️', base: 2350 },
  ...
  { id: 'speaker-soundbar', category: 'Колонки', tier: 0, name: 'Компактный саундбар', emoji: '🔊', base: 2750 },
  ...
  { id: 'gamepad-arcade', category: 'Геймпады', tier: 0, name: 'Аркадный контроллер', emoji: '🕹️', base: 3900 },
  ...
  { id: 'sneakers-hightop', category: 'Кроссовки', tier: 0, name: 'Высокие кеды', emoji: '👟', base: 3200 },
  ...
  { id: 'watch-hybrid', category: 'Часы', tier: 0, name: 'Гибридные смарт-часы', emoji: '⌚', base: 3500 },
  ...
  { id: 'audio-interface', category: 'Аудио', tier: 0, name: 'Компактная звуковая карта', emoji: '🎚️', base: 4100 },
  ...
  { id: 'usb-hub', category: 'Гаджеты', tier: 0, name: 'USB-C док-станция', emoji: '🔌', base: 2600 },
  { id: 'mini-printer', category: 'Гаджеты', tier: 0, name: 'Карманный фотопринтер', emoji: '🖨️', base: 4700 },
  ...
  { id: 'phone-rugged', category: 'Смартфоны', tier: 1, name: 'Защищённый смартфон', emoji: '📱', base: 17800 },
  { id: 'phone-fold-old', category: 'Смартфоны', tier: 1, name: 'Складной смартфон прошлых лет', emoji: '📱', base: 28500 },
  ...
  { id: 'console-retro', category: 'Приставки', tier: 2, name: 'Ретро-приставка с играми', emoji: '🕹️', base: 18500 },
  { id: 'console-vr', category: 'Приставки', tier: 2, name: 'VR-шлем с контроллерами', emoji: '🥽', base: 43000 },
  ...
  { id: 'sneakers-collab', category: 'Дорогие кроссовки', tier: 2, name: 'Кроссовки из коллаборации', emoji: '👟', base: 47000 },
  ...
  { id: 'tablet-gaming', category: 'Планшеты', tier: 3, name: 'Игровой планшет', emoji: '📲', base: 64000 },
  { id: 'tablet-display', category: 'Планшеты', tier: 3, name: 'Графический дисплей', emoji: '✍️', base: 82000 },
  ...
  { id: 'laptop-convertible', category: 'Ноутбуки', tier: 4, name: 'Ноутбук-трансформер', emoji: '💻', base: 72000 },
  { id: 'laptop-creator', category: 'Ноутбуки', tier: 4, name: 'Ноутбук для дизайнера', emoji: '💻', base: 112000 },
  ...
  { id: 'camera-cinema', category: 'Дорогая электроника', tier: 5, name: 'Компактная кинокамера', emoji: '🎥', base: 145000 },
  { id: 'audio-monitors', category: 'Дорогая электроника', tier: 5, name: 'Студийные мониторы', emoji: '🔊', base: 175000 },
  { id: 'projector-laser', category: 'Дорогая электроника', tier: 5, name: 'Лазерный проектор', emoji: '📽️', base: 225000 },
  { id: 'drone-pro', category: 'Дорогая электроника', tier: 5, name: 'Профессиональный дрон', emoji: '🚁', base: 285000 },
  { id: 'desktop-compact', category: 'Дорогая электроника', tier: 5, name: 'Компактная рабочая станция', emoji: '🖥️', base: 305000 },
];
